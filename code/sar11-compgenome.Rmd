...
#THE GENOME TABLE
```{r}
gnm.tbl <- suppressMessages(read_delim("/home/jovyan/github/susan-compgenome/code/Candidatus_Pelagibacter.csv", delim = ",")) %>% 
...
for(i in 1:nrow(gnm.tbl)){
  ...
  download.file(url = file.path(gnm.tbl$GenBank_FTP[i], "Candidatus_Pelagibacter.csv"),
                destfile = file.path("code", "Candidatus_Pelagibacter.csv"))
