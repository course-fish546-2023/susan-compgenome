...
bltabl1 <- read.csv("../susan-compgenome/output/45-95_blastp.tab", sep = '\t', header = FALSE)
...
Having the comparison of 45 to GCA_000155895.1 into a CSV file.
```{r, eval=TRUE}
# Read out the blast file into csv
bltabl2 <- read.csv("../susan-compgenome/output/bigblast-01/GCA_000155895.1_45_blastp.tab", sep = '\t', header = FALSE)
...
```{r, eval=TRUE}
spgo <- read.csv("../susan-compgenome/output/45protein.tab", sep = '\t', header = TRUE)
